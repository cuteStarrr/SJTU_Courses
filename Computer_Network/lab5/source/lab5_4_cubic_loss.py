...
class SingleSwitchTopo( Topo ):
    def build( self ):
        ...
        self.addLink(host1, switch1, bw=100, delay=0, loss=0, use_htb=True)
        self.addLink(host3, switch1, bw=100, delay=0, loss=0.1, use_htb=True)
        self.addLink(host2, switch2, bw=100, delay=0, loss=0, use_htb=True)
        self.addLink(host4, switch2, bw=100, delay=0, loss=0.1, use_htb=True)
